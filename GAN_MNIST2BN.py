...
GFc1=tf.nn.relu(batch_norm(tf.matmul(NoiseP,WGFc1)+BGFc1,BNistrain))

WGFc2=weight_variable([150,300])
BGFc2=bias_variable([300])
GFc2=tf.nn.relu(batch_norm(tf.matmul(GFc1,WGFc2)+BGFc2,BNistrain))
...
D1Fc1= tf.nn.relu(tf.matmul(Tp,WDFc1)+BDFc1)
D2Fc1= tf.nn.relu(tf.matmul(GFc3,WDFc1)+BDFc1)

WDFc2=weight_variable([300,150])
BDFc2=bias_variable([150])
D1Fc2=tf.nn.relu(batch_norm(tf.matmul(D1Fc1,WDFc2)+BDFc2,BNistrain))
D2Fc2=tf.nn.relu(batch_norm(tf.matmul(D2Fc1,WDFc2)+BDFc2,BNistrain))
